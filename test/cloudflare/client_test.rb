  ...
  module Cloudflare
    class ClientTest < Minitest::Test
      ...
      def test_get_zone_id_returns_zone_id
        stub_request(:get, /api\.cloudflare\.com\/client\/v4\/zones/)
      ...
      def test_ensure_dns_record_skips_when_exists
        stub_request(:get, /dns_records/).to_return(
          status: 200, body: { success: true, result: [{ id: "dns-1", name: "app.example.com", content: "tun-1.cfargotunnel.com" }] }.to_json, headers: json_headers)
        @client.ensure_dns_record("zone-1", "app.example.com", "tun-1")
