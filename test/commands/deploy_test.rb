    ...
    class DeployTest < Minitest::Test
      ...
      def stub_hetzner_infrastructure!
        ...
        stub_request(:get, /hetzner\.cloud\/v1\/networks/).to_return(
          status: 200, body: { networks: [{ id: 1, name: @ctx.prefix, ip_range: "10.0.0.0/16" }] }.to_json, headers: json_headers)
      ...
      def stub_cloudflare!
        ...
        stub_request(:get, /cfd_tunnel\/tun-1\/token/).to_return(
          status: 200, body: { success: true, result: "cf-token" }.to_json, headers: json_headers)
        stub_request(:put, /cfd_tunnel\/tun-1\/configurations/).to_return(
          status: 200, body: { success: true, result: {} }.to_json, headers: json_headers)
